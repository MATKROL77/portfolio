...
export const profile = {
  ...
  summary:
    "Diseño mecánico y CAD en Fusion 360 y Solid Edge, con experiencia comercial propia: desde 2024 llevo mi servicio de impresión 3D y diseño personalizado, donde relevo el pedido, lo cotizo, lo diseño, lo produzco y lo entrego. Estudio Ingeniería Mecánica en la UTN, Facultad Regional General Pacheco, tengo inglés C1 y hoy hago una pasantía de proyectos en OPmobility, donde analizo piezas inyectadas que salen fuera de tolerancia, valido en 3D, sigo el avance del proyecto y trabajo entre planta, ingeniería y finanzas. Me manejo igual de cómodo frente al modelo 3D que frente a la persona que lo pidió.",
...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    current: true,
    kind: "propio",
    body: "Mi propio negocio: diseño y fabrico piezas, carteles y maquetas para clientes de arquitectura, comercios y uso general. Manejo el ciclo completo y soy la única cara visible frente al cliente: relevo qué necesita, lo cotizo con su plazo, lo diseño en Fusion 360, planifico la producción y lo entrego. Cuando un trabajo tiene un problema antes de producir, defino yo el prototipo: qué hay que probar, en qué material y a qué escala.",
    bullets: [
      "Relevamiento con el cliente",
      "Cotización y presupuesto",
      "Diseño CAD (Fusion 360)",
      "Prototipado para validar",
